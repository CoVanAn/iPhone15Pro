        ...
        <div className='h-full common-padding bg-zinc relative overflow-hidden'>
            <div className='screen-max-width'>
                <div className='mb-12 w-full'>
                    <p id='features_title' className='section-heading'>Explore the full story.</p>
                </div>
                <div className='flex flex-col justify-center items-center overflow-hidden'>
                    <div className='mt-32 mb-24 pl-24'>
                        <p className='text-gray text-5xl lg:text-7xl font-bold'>iPhone.</p>
                        <p className='text-gray text-5xl lg:text-7xl font-bold'>Forged in titanium.</p>
                    </div>
